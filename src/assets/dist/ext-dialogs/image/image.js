/**
 * 重写dialogs/image/image.js
 * 可配置是否屏蔽在线图片管理, 在线搜索图片
 */
...
(function () {
    ...
    window.onload = function () {
        if (editor.getOpt('allowOnlineImage')) {
            initOnline();
        }
        if (editor.getOpt('allowSearchImage')) {
            initSearch();
        }
        initTabs();
        initAlign();
    ...
    function initOnline() {
        $('#tabhead').append('<span class="tab" data-content-id="online"><var id="lang_tab_online"></var></span>');
        $('#tabbody').append('<div id="online" class="panel"><div id="imageList"><var id="lang_imgLoading"></var></div></div>');
        loadStaticLangByList(['lang_tab_online', 'lang_imgLoading']);
    }

    function initSearch() {
        $('#tabhead').append('<span class="tab" data-content-id="search"><var id="lang_tab_search"></var></span>');
        $('#tabbody').append('<div id="search" class="panel"><div class="searchBar">\
        ...
        loadStaticLangByList(['lang_tab_search']);
        loadStaticLangBySelector('#search');
    }
